              ...
              <div className="w-full lg:w-2/5">
                <div className="relative h-auto lg:h-[1050px] space-y-6 md:space-y-8">
                  <div className="relative h-[450px] md:h-[500px] rounded-2xl overflow-hidden shadow-lg">
                    <Image
                      src="/images/collection-pateners/collection-right-side-images/Saloon/Spa-Saloon/Spa_Saloon 1.png"
                  ...
                  <div className="relative h-[450px] md:h-[500px] rounded-2xl overflow-hidden shadow-lg">
                    <Image
                      src="/images/collection-pateners/collection-right-side-images/Saloon/Spa-Saloon/Spa_Saloon 2.png"
