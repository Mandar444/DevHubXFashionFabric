...
import { ChevronDown, Plane, Award, ShieldCheck, Zap, ArrowRight, Quote, Sparkles } from "lucide-react"
            ...
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
              <AnimateInStagger>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-amber-500 font-bold tracking-[0.5em] uppercase text-xs">The Celestial Fleet</span>
                </div>
                
                <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-8 font-garamond italic leading-tight">
                  Aviation <br /><span className="text-amber-500 text-glow">Excellence</span>
                </h1>
                
                <p className="text-white/70 text-lg md:text-2xl font-light italic leading-relaxed font-garamond mb-12">
                  "We design aviation uniforms that combine elegance, functionality, and worldwide brand compliance. From flight attendants to ground staff, our fabrics are wrinkle-resistant and breathable, ensuring your team looks sharp and ready to serve at any altitude."
                </p>
              ...
              <AnimateIn direction="right" className="relative group">
                ...
                <div className="relative aspect-square md:aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    ...
                    alt="Elite Aviation Presentation"
                    fill
                ...
                <div className="absolute -top-8 -right-8 w-32 h-32 bg-black border border-amber-500/30 rounded-full flex items-center justify-center shadow-2xl z-20 animate-pulse">
                  <Plane className="text-amber-500 w-12 h-12 -rotate-45" />
                </div>
              </AnimateIn>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center mb-24">
            <AnimateIn>
              ...
              <h2 className="text-4xl md:text-7xl font-bold text-white mb-8 font-garamond italic">
                Built for <span className="text-amber-500">The Skies</span>
              </h2>
          ...
          <AnimateInStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { 
                ...
                desc: "Wrinkle-resistant materials tested for high-altitude durability and supreme comfort.", 
                icon: "/images/collections-images/built-on-icons/Icons-07 1.svg" 
              },
              { 
                title: "Precision Fit", 
                desc: "Ergonomically patterned to move with your crew through every stage of the flight.", 
                icon: "/images/collections-images/built-on-icons/Icons-08 1.svg" 
              },
              { 
                title: "Reliable Fulfilment", 
                desc: "Global hub distribution, quality-controlled kits, and white-glove delivery.", 
                icon: "/images/collections-images/built-on-icons/Icons-09 1.svg" 
              },
              { 
                title: "Ethical Sourcing", 
                desc: "Eco-conscious materials and sustainable growth models for a cleaner sky.", 
          ...
          <AnimateInStagger className="flex flex-col lg:flex-row items-center gap-24">
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-4xl md:text-7xl font-bold text-white mb-12 font-garamond italic leading-tight">
                Sky-Bound <br className="hidden sm:block" /><span className="text-amber-500">Service</span>
              </h2>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {[
                  { title: "Personal Concierge", desc: "A single expert point of contact for your entire global fleet.", icon: "/images/collection-pateners/Icons-01 1.svg" },
                  { title: "Flexible Quantities", desc: "From urgent replacements to massive airline-wide rollouts.", icon: "/images/collection-pateners/Icons-02 1.svg" },
                  { title: "Master Speed", desc: "Rapid measurements, trials, and production to meet flight schedules.", icon: "/images/collection-pateners/Icons-03 1.svg" },
                  { title: "Global Capacity", desc: "Scalable production that stays in sync with your global expansion.", icon: "/images/collection-pateners/Icons-04 1.svg" }
                ].map((item, i) => (
      ...
      <section className="py-40 relative overflow-hidden bg-black">
        <div className="container px-4 md:px-6">
          <AnimateIn className="flex flex-col items-center text-center mb-24">
            <span className="text-amber-500 font-bold tracking-[0.5em] uppercase text-xs mb-6 block">Flight Clearance</span>
            <h2 className="text-4xl md:text-7xl font-bold text-white mb-8 font-garamond italic">
               ...
               <Quote className="absolute -top-10 -left-10 text-white/5 w-64 h-64 rotate-12" />
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                  <h2 className="text-4xl sm:text-6xl md:text-8xl font-bold text-white mb-8 font-garamond italic text-glow leading-tight">
                    Ready to <span className="text-amber-500">Take Flight</span>?
                  </h2>
                  <p className="text-white/70 text-lg md:text-3xl font-garamond italic font-light mb-12 md:text-16 leading-relaxed">
                    "Elevate your brand beyond the horizon. Let us script your airline's visual identity."
                  </p>
                  <Link href="/enquiry">
