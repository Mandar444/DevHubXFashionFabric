            ...
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
              <AnimateInStagger>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-amber-500 font-bold tracking-[0.5em] uppercase text-xs">The Sanctuary Suite</span>
                </div>
                
                <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-8 font-garamond italic leading-tight">
                  Healthcare <br /><span className="text-amber-500">Care</span>
                </h1>
                
                <p className="text-white/70 text-lg md:text-2xl font-light italic leading-relaxed font-garamond mb-12">
                  "We make uniforms for healthcare professionals with hygiene and functionality as the top priority. Made from durable, easy-to-clean fabrics and crafted for comfort and ease of movement, each uniform keeps staff ready for a long day without compromising their dignity."
                </p>
              ...
              <AnimateIn direction="right" className="relative group">
                ...
                <div className="relative aspect-square md:aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    ...
                    alt="Elite Healthcare Presentation"
                    fill
          ...
          <div className="flex flex-col items-center text-center mb-24">
            <AnimateIn>
              ...
              <h2 className="text-4xl md:text-7xl font-bold text-white mb-8 font-garamond italic">
                The Fabric of <span className="text-amber-500">Care</span>
              </h2>
