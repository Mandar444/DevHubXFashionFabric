...
import { ChevronDown, Star, Award, ShieldCheck, Zap, ArrowRight, Quote, BookOpen } from "lucide-react"
            ...
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
              <AnimateInStagger>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-amber-500 font-bold tracking-[0.5em] uppercase text-xs">The Academy Suite</span>
                </div>
                
                <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-8 font-garamond italic leading-tight">
                  Educational <br /><span className="text-amber-500">Institutes</span>
                </h1>
                
                <p className="text-white/70 text-lg md:text-2xl font-light italic leading-relaxed font-garamond mb-12">
                  "We craft durable, high-quality uniforms that instill pride and belonging. Designed for comfort and everyday wear, our uniforms maintain their smart appearance wash after wash, supporting students from classroom to playground."
                </p>
              ...
              <AnimateIn direction="right" className="relative group">
                ...
                <div className="relative aspect-square md:aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    ...
                    alt="Elite Academy Presentation"
                    fill
                ...
                <div className="absolute -top-8 -right-8 w-32 h-32 bg-black border border-amber-500/30 rounded-full flex items-center justify-center shadow-2xl z-20 animate-pulse">
                  <BookOpen className="text-amber-500 w-12 h-12" />
                </div>
              </AnimateIn>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center mb-24">
            <AnimateIn>
              ...
              <h2 className="text-4xl md:text-7xl font-bold text-white mb-8 font-garamond italic">
                The Fabric of <span className="text-amber-500">Pride</span>
              </h2>
