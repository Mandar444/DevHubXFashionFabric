...
import { ChevronDown, Utensils, Award, ShieldCheck, Zap, ArrowRight, Quote, Sparkles } from "lucide-react"
            ...
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
              <AnimateInStagger>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-amber-500 font-bold tracking-[0.5em] uppercase text-xs">The Culinary Kingdom</span>
                </div>
                
                <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-8 font-garamond italic leading-tight">
                  Restaurants <br />& <span className="text-amber-500 text-glow">Bars</span>
                </h1>
                
                <p className="text-white/70 text-lg md:text-2xl font-light italic leading-relaxed font-garamond mb-12">
                  "Whether you operate a boutique fine-dining restaurant or a high-volume service chain, our uniforms are built for performance, comfort, and brand expression. Designed for long shifts and fast-paced environments, they offer the right balance of style, mobility, and durability."
                </p>
              ...
              <AnimateIn direction="right" className="relative group">
                ...
                <div className="relative aspect-square md:aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    ...
                    alt="Elite Culinary Presentation"
                    fill
                ...
                {/* Culinary Indicator Badge */}
                <div className="absolute -top-8 -left-8 w-32 h-32 bg-black border border-amber-500/30 rounded-full flex items-center justify-center shadow-2xl z-20 animate-spin-slow">
                  <Utensils className="text-amber-500 w-12 h-12" />
                </div>
              </AnimateIn>
            </div>
          </div>
      ...
      <section className="py-32 relative overflow-hidden bg-black">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center text-center mb-24">
            <AnimateIn>
              <span className="text-amber-500 font-bold tracking-[0.5em] uppercase text-xs mb-6 block">Service Engineering</span>
              <h2 className="text-4xl md:text-7xl font-bold text-white mb-8 font-garamond italic">
                Crafted for <span className="text-amber-500">Service</span>
              </h2>
          ...
          <AnimateInStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { 
                ...
                desc: "Breathable and stain-resistant materials tested for long, fast-paced culinary shifts.", 
                icon: "/images/collections-images/built-on-icons/Icons-07 1.svg" 
              },
              { 
                title: "Precision Fit", 
                desc: "Designed for supreme mobility in high-heat and high-motion environments.", 
                icon: "/images/collections-images/built-on-icons/Icons-08 1.svg" 
              },
              { 
                title: "Reliable Fulfilment", 
                desc: "Nationwide delivery with rigorous quality checks for consistent branding.", 
                icon: "/images/collections-images/built-on-icons/Icons-09 1.svg" 
              },
              { 
                title: "Ethical Sourcing", 
                desc: "Eco-conscious materials and fair-trade practices for a better culinary world.", 
          ...
          <AnimateInStagger className="flex flex-col lg:flex-row items-center gap-24">
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-4xl md:text-7xl font-bold text-white mb-12 font-garamond italic leading-tight">
                Gourmet <br /><span className="text-amber-500">Presentation</span>
              </h2>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {[
                  { title: "Personal Concierge", desc: "A single expert point of contact for your entire restaurant group.", icon: "/images/collection-pateners/Icons-01 1.svg" },
                  { title: "Flexible Quantities", desc: "From small concept cafés to massive hospitality chains.", icon: "/images/collection-pateners/Icons-02 1.svg" },
                  { title: "Master Speed", desc: "Fast-track design and delivery for new venue openings.", icon: "/images/collection-pateners/Icons-03 1.svg" },
                  { title: "Scalable Production", desc: "Our capacity grows as your culinary empire expands.", icon: "/images/collection-pateners/Icons-04 1.svg" }
                ].map((item, i) => (
            ...
            <div className="w-full lg:w-1/2">
               <div className="relative group">
                  ...
                  {/* Decorative Label */}
                  <div className="absolute -bottom-8 right-12 bg-amber-500 text-black px-8 py-3 rounded-full font-bold tracking-[0.2em] uppercase text-xs shadow-xl">
                    Royal LOOKBOOK
                  </div>
               </div>
            </div>
      ...
      <section className="py-40 relative overflow-hidden bg-black">
        <div className="container px-4 md:px-6">
          <AnimateIn className="flex flex-col items-center text-center mb-24">
            <span className="text-amber-500 font-bold tracking-[0.5em] uppercase text-xs mb-6 block">Service Inquiries</span>
            <h2 className="text-4xl md:text-7xl font-bold text-white mb-8 font-garamond italic">
            ...
            <AnimateIn className="bg-white/5 backdrop-blur-xl rounded-[4rem] p-12 md:p-24 border border-white/10 text-center relative overflow-hidden">
               ...
               <Quote className="absolute -top-10 -left-10 text-white/5 w-64 h-64 rotate-12" />
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                  <h2 className="text-4xl sm:text-6xl md:text-8xl font-bold text-white mb-8 font-garamond italic text-glow leading-tight">
                    Ready to <span className="text-amber-500">Serve Excellence</span>?
                  </h2>
                  <p className="text-white/70 text-lg md:text-3xl font-garamond italic font-light mb-12 leading-relaxed">
                    "Transform your dining experience into a visual masterpiece. Let us script your venue's identity."
                  </p>
                  <Link href="/enquiry">
