      ...
      <div className="container mx-auto max-w-6xl relative z-10 text-center">
        ...
        <AnimateIn delay={0.2}>
          <div className="relative h-[550px] sm:h-[600px] md:h-[750px] flex items-center justify-center perspective-[2000px]">
            ...
            {/* Main Center Card - Responsive White Aesthetic */}
            <div className="relative z-30 flex flex-col items-center justify-between text-center bg-white text-neutral-900 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-20 w-[95%] sm:w-[500px] md:w-[650px] h-full max-h-[520px] sm:max-h-[580px] md:max-h-[700px] border border-neutral-100 group transition-all duration-700 hover:scale-[1.02]">
              <div className="text-neutral-200 transform group-hover:scale-110 transition-transform duration-500">
                <Quote size={40} className="md:w-24 md:h-24" fill="currentColor" />
              </div>
              
              <div className="text-[9px] md:text-xs tracking-[0.2em] md:tracking-[0.3em] font-bold uppercase py-1.5 md:py-2 px-6 md:px-8 rounded-full border-2 border-neutral-100 text-neutral-400 my-4 md:my-8 whitespace-nowrap">
                VERIFIED PARTNER V3
              </div>

              <h3 className="font-serif font-bold text-xl md:text-5xl mb-1 md:mb-2 text-neutral-900 tracking-tight">F&B Director</h3>
              <p className="text-[9px] md:text-sm tracking-[0.3em] md:tracking-[0.4em] uppercase mb-6 md:mb-10 text-neutral-400">LUXURY RESORT IN GOA</p>

              <p className="leading-relaxed italic flex-grow text-sm md:text-2xl font-medium text-neutral-800 max-w-[95%] mb-4">
              ...
              <div className="flex gap-1.5 md:gap-3 mb-6 md:mb-12 w-full justify-center">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} size={18} className="md:size-7 text-yellow-400 fill-yellow-400 drop-shadow-[0_2px_4px_rgba(0,0,0,0.1)]" />
                ))}
              </div>
